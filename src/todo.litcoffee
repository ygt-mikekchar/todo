...
I though it would be nice to write something that explains
some of the ideas.
...
Unfortunately, literate Coffeescript does not have that ability.
It's really just coffeescript embedded in a Markdown document.
Because of that, I will try to add links that will follow
the natural presentation order of the material.

For example, [please follow this link](literate-example.litcoffee)
